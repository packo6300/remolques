<?php /* Smarty version 3.1.26, created on 2015-12-29 18:25:22
         compiled from "C:\xampp\htdocs\modulos\Renta\templates\RentaPDF.html" */ ?>
<?php
/*%%SmartyHeaderCode:272755683085202b673_12003133%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '272755683085202b673_12003133',
  'variables' => 
  array (
    'folio' => 0,
    'nombre' => 0,
  ...
  'version' => '3.1.26',
  'unifunc' => 'content_5683085214b750_76476077',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5683085214b750_76476077')) {
function content_5683085214b750_76476077 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '272755683085202b673_12003133';
?>
<!DOCTYPE html>
<!--
        ...
        <table style="width: 750px;" border="0" >
                <tr>
                    ...
                    <th valign="middle" style="height: 30px;" colspan="4" width="50%" bgcolor="#F0F0F0">Remolque:</th>
                        ...
                        <td><?php echo $_smarty_tpl->tpl_vars['color']->value;?>
</td>
                        ...
                        <td colspan="3"><?php echo $_smarty_tpl->tpl_vars['autplaca']->value;?>
</td>
                        
                </tr><tr>
                        <th colspan="8" bgcolor="#F0F0F0">Referencia:</th>
                </tr><tr>
                    <th colspan="2" bgcolor="#F0F0F0">Dirección:</th>
                    <td colspan="6"><?php echo $_smarty_tpl->tpl_vars['rdir']->value;?>
</td>
                </tr><tr>
                        <th colspan="2" bgcolor="#F0F0F0">Nombre:</th>
                        <td colspan="4"><?php echo $_smarty_tpl->tpl_vars['rnombre']->value;?>
</td>
    ...
    <tr>
        <td>
            <ul style="font-size: x-small;">
                ...
                <li>Al entregar usted el remolque o dolly, se revisara detalladamente y se harán cargos por los daños enconrados.</li>
                <li>Su pago por la renta del remolque o dolly, No incluye servicio de asistencia local y/o carreteras, por lo que se recomienda revisar el requipo antes de salir.</li>
                <li>El arrendatario sera su responsabilidad civil o penal en caso de accidente, así coo la entrega del equipo en las condiciones en las que sale de la empresa.</li>
                ...
                <li>Estrictamente prohibido traspasar, subarrendar o ceder sus derechos de todo o parte del remolque.</li>
            </ul>
            <center>_______________<br>Acepto.  </center>
        </td>
    </tr>
</table>
<br>
...
<table style="width:750px;">
 ...
 DEL <?php echo $_smarty_tpl->tpl_vars['year']->value;?>
        ...
        <td colspan="3"><p style="font-size: x-small;margin: auto;">Debo(emos) y pagaré(mos) incondicionalmente por este pagaré a la orden de Martha Canales Ochoa en calle 81a. y 15a.#8407 col. Aeropuerto en la ciudad de chihuahua,Chih. <?php echo $_smarty_tpl->tpl_vars['f']->value;?>
</p>
    </tr><tr>
        <td align="left" style="font-size: x-small;" colspan="3">la cantidad de:</td>
    </tr><tr>
        <td colspan="3" style="font-size: x-small;border:1px solid black;"><b><?php echo $_smarty_tpl->tpl_vars['s']->value;?>
 <label>00/100</label></b></td>
    </tr><tr>
...
<br> <b>Dirección: </b> <?php echo $_smarty_tpl->tpl_vars['direccion']->value;?>
 ...
 <br> <b>Población:</b>_______________________________________</td>
        <td colspan="2">Acepto(amos)<br>Firma(s):_______________</td>
    </tr>
</table>
</body>
</html>
