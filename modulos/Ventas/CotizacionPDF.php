...
//carga caratula oc
$sql="SELECT * FROM cotizacion where idcotizacion=$idr";
$res=consulta($sql);
...
/////////////////////////////////////////////////
//carga detalle oc
$sql2="SELECT * FROM cotizaciondetail where idcotizacion=$idr;";
$res3=array();
$res2=consulta($sql2);
$suma=0;
foreach ($res2 as  $row2) {
    $suma=$suma+($row2['subtotal']*$row2['cantidad']);            
}
...
$t->display($root.'/modulos/Ventas/templates/CotizacionPdf.tpl');
