    ...
    <body>
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1">
            <tr>
                ...
                <td><center><b>{if $estatus eq "Aplicada"}Nota de venta{else}Cotización{/if}</b><br><br><label style="width: 4px;">Nº:</label><label style="width: 15px;">{$folio}</label></center>
...
<tr>
	...
	<td  colspan="3" th="90%">{$direccion}</td>	
</tr>
<tr>
...
<tr>
<td align="right">{$productos[i].cant}</td>
	<td align="center">{$productos[i].art}</td>
	<td><b>{$productos[i].descr}</b><br></td>
	<td align="right">{$productos[i].precio|string_format:"%.2f"}</td>
