...
//carga caratula oc
    $sql="SELECT * FROM oclistar where folio=$idr";
       $res=consulta($sql);
        foreach ($res as  $row) {
            $t->assign("nombre",$row['nombre']);
        ...
        /////////////////////////////////////////////////
        //carga detalle oc
        $sql2="SELECT * FROM ocdetalle where foliooc=$idr;";
        $res3=array();
        $res2=consulta($sql2);
        ...
        $t->assign("folio",$idr);
$t->display($root.'/modulos/Compras/templates/OcPDF.html');
